...
public class LogConfig implements org.apache.thrift.TBase<LogConfig, LogConfig._Fields>, java.io.Serializable, Cloneable {
  ...
  public int hashCode() {
    ...
    builder.append(present_named_logger_level);
    if (present_named_logger_level)
      builder.append(named_logger_level);
  ...
  public int compareTo(LogConfig other) {
    ...
    lastComparison = Boolean.valueOf(is_set_named_logger_level()).compareTo(typedOther.is_set_named_logger_level());
    if (lastComparison != 0) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i655 = 0; _i655 < _map654.size; ++_i655)
                {
                  ...
                  LogLevel _val657; // required
                  _key656 = iprot.readString();
                  _val657 = new LogLevel();
                  _val657.read(iprot);
                  struct.named_logger_level.put(_key656, _val657);
                }
                iprot.readMapEnd();
              }
      ...
      if (incoming.get(0)) {
        {
          ...
          for (int _i661 = 0; _i661 < _map660.size; ++_i661)
          {
            ...
            LogLevel _val663; // required
            _key662 = iprot.readString();
            _val663 = new LogLevel();
            _val663.read(iprot);
            struct.named_logger_level.put(_key662, _val663);
          }
        }
        struct.set_named_logger_level_isSet(true);
      }
