...
public class LSApprovedWorkers implements org.apache.thrift.TBase<LSApprovedWorkers, LSApprovedWorkers._Fields>, java.io.Serializable, Cloneable {
  ...
  public int hashCode() {
    ...
    builder.append(present_approved_workers);
    if (present_approved_workers)
      builder.append(approved_workers);
  ...
  public int compareTo(LSApprovedWorkers other) {
    ...
    lastComparison = Boolean.valueOf(is_set_approved_workers()).compareTo(typedOther.is_set_approved_workers());
    if (lastComparison != 0) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.approved_workers = new HashMap<String,Integer>(2*_map626.size);
                for (int _i627 = 0; _i627 < _map626.size; ++_i627)
                {
                  String _key628; // required
                  int _val629; // required
                  _key628 = iprot.readString();
                  _val629 = iprot.readI32();
                  struct.approved_workers.put(_key628, _val629);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LSApprovedWorkers struct) throws org.apache.thrift.TException {
      ...
      if (struct.approved_workers != null) {
        oprot.writeFieldBegin(APPROVED_WORKERS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Integer> _iter630 : struct.approved_workers.entrySet())
          {
            oprot.writeString(_iter630.getKey());
            oprot.writeI32(_iter630.getValue());
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class LSApprovedWorkersTupleScheme extends TupleScheme<LSApprovedWorkers> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, LSApprovedWorkers struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<String, Integer> _iter631 : struct.approved_workers.entrySet())
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LSApprovedWorkers struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TMap _map632 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I32, iprot.readI32());
        struct.approved_workers = new HashMap<String,Integer>(2*_map632.size);
        for (int _i633 = 0; _i633 < _map632.size; ++_i633)
        {
          String _key634; // required
          int _val635; // required
          _key634 = iprot.readString();
          _val635 = iprot.readI32();
          struct.approved_workers.put(_key634, _val635);
        }
      }
      struct.set_approved_workers_isSet(true);
    }
