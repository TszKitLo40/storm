...
public class TopologyStats implements org.apache.thrift.TBase<TopologyStats, TopologyStats._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(TopologyStats other) {
    ...
    lastComparison = Boolean.valueOf(is_set_window_to_emitted()).compareTo(typedOther.is_set_window_to_emitted());
    if (lastComparison != 0) {
    ...
    lastComparison = Boolean.valueOf(is_set_window_to_transferred()).compareTo(typedOther.is_set_window_to_transferred());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(is_set_window_to_complete_latencies_ms()).compareTo(typedOther.is_set_window_to_complete_latencies_ms());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(is_set_window_to_acked()).compareTo(typedOther.is_set_window_to_acked());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(is_set_window_to_failed()).compareTo(typedOther.is_set_window_to_failed());
    if (lastComparison != 0) {
      return lastComparison;
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i345 = 0; _i345 < _map344.size; ++_i345)
                {
                  ...
                  long _val347; // required
                  _key346 = iprot.readString();
                  _val347 = iprot.readI64();
                  struct.window_to_emitted.put(_key346, _val347);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i349 = 0; _i349 < _map348.size; ++_i349)
                {
                  ...
                  struct.window_to_transferred.put(_key350, _val351);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i353 = 0; _i353 < _map352.size; ++_i353)
                {
                  ...
                  double _val355; // required
                  _key354 = iprot.readString();
                  _val355 = iprot.readDouble();
                  struct.window_to_complete_latencies_ms.put(_key354, _val355);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i357 = 0; _i357 < _map356.size; ++_i357)
                {
                  ...
                  long _val359; // required
                  _key358 = iprot.readString();
                  _val359 = iprot.readI64();
                  struct.window_to_acked.put(_key358, _val359);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i361 = 0; _i361 < _map360.size; ++_i361)
                {
                  ...
                  long _val363; // required
                  _key362 = iprot.readString();
                  _val363 = iprot.readI64();
                  struct.window_to_failed.put(_key362, _val363);
                }
                iprot.readMapEnd();
              }
      ...
      if (incoming.get(0)) {
        {
          ...
          for (int _i375 = 0; _i375 < _map374.size; ++_i375)
          {
            ...
            long _val377; // required
            _key376 = iprot.readString();
            _val377 = iprot.readI64();
            struct.window_to_emitted.put(_key376, _val377);
          }
        }
        struct.set_window_to_emitted_isSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          for (int _i379 = 0; _i379 < _map378.size; ++_i379)
          {
            ...
            struct.window_to_transferred.put(_key380, _val381);
          }
        }
        struct.set_window_to_transferred_isSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          for (int _i383 = 0; _i383 < _map382.size; ++_i383)
          {
            ...
            double _val385; // required
            _key384 = iprot.readString();
            _val385 = iprot.readDouble();
            struct.window_to_complete_latencies_ms.put(_key384, _val385);
          }
        }
        struct.set_window_to_complete_latencies_ms_isSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          for (int _i387 = 0; _i387 < _map386.size; ++_i387)
          {
            ...
            long _val389; // required
            _key388 = iprot.readString();
            _val389 = iprot.readI64();
            struct.window_to_acked.put(_key388, _val389);
          }
        }
        struct.set_window_to_acked_isSet(true);
      }
      if (incoming.get(4)) {
        {
          ...
          for (int _i391 = 0; _i391 < _map390.size; ++_i391)
          {
            ...
            struct.window_to_failed.put(_key392, _val393);
          }
        }
        struct.set_window_to_failed_isSet(true);
      }
