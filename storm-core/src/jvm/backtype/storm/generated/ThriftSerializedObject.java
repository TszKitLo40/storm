...
;
  ...
  public void set_bits(byte[] bits) {
    set_bits(bits == null ? (ByteBuffer)null : ByteBuffer.wrap(bits));
  }
  ...
  public int compareTo(ThriftSerializedObject other) {
    ...
    lastComparison = Boolean.valueOf(is_set_bits()).compareTo(typedOther.is_set_bits());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_bits()) {
