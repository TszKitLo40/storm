...
public class ChangeDistributionService {
  ...
  public interface AsyncIface {
    ...
    public void changeNumberOfElements(int numberofElements, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;

    public void changeExponent(double exponent, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_changeNumberOfElements(int numberofElements) throws org.apache.thrift.TException
    {
      ...
      args.set_numberofElements(numberofElements);
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class changeNumberOfElements_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public changeNumberOfElements_call(int numberofElements, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
    ...
    public static class changeExponent_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public changeExponent_call(double exponent, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class changeNumberOfElements<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, changeNumberOfElements_args, Void> {
      ...
      public void start(I iface, changeNumberOfElements_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws TException {
    ...
    public static class changeExponent<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, changeExponent_args, Void> {
      ...
      public void start(I iface, changeExponent_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws TException {
  ...
  public static class changeNumberOfElements_args implements org.apache.thrift.TBase<changeNumberOfElements_args, changeNumberOfElements_args._Fields>, java.io.Serializable, Cloneable, Comparable<changeNumberOfElements_args>   {
      ...
      int numberofElements)
    {
      this();
      this.numberofElements = numberofElements;
      set_numberofElements_isSet(true);
    }
    ...
    @Override
    public void clear() {
      set_numberofElements_isSet(false);
    ...
    public void set_numberofElements(int numberofElements) {
      this.numberofElements = numberofElements;
      set_numberofElements_isSet(true);
    }

    public void unset_numberofElements() {
    ...
    public boolean is_set_numberofElements() {
      return EncodingUtils.testBit(__isset_bitfield, __NUMBEROFELEMENTS_ISSET_ID);
    }

    public void set_numberofElements_isSet(boolean value) {
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case NUMBEROF_ELEMENTS:
        if (value == null) {
          unset_numberofElements();
        } else {
          set_numberofElements((Integer)value);
        }
        break;
    ...
    public Object getFieldValue(_Fields field) {
      switch (field) {
      case NUMBEROF_ELEMENTS:
        return Integer.valueOf(get_numberofElements());
    ...
    public boolean isSet(_Fields field) {
      ...
      switch (field) {
      case NUMBEROF_ELEMENTS:
        return is_set_numberofElements();
      }
      throw new IllegalStateException();
    }
    ...
    public int compareTo(changeNumberOfElements_args other) {
      ...
      lastComparison = Boolean.valueOf(is_set_numberofElements()).compareTo(other.is_set_numberofElements());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (is_set_numberofElements()) {
          ...
          switch (schemeField.id) {
            case 1: // NUMBEROF_ELEMENTS
              if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
                ...
                struct.set_numberofElements_isSet(true);
              } else { 
    ...
    private static class changeNumberOfElements_argsTupleScheme extends TupleScheme<changeNumberOfElements_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, changeNumberOfElements_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.is_set_numberofElements()) {
          optionals.set(0);
        }
...
;
  ...
  public static class changeExponent_args implements org.apache.thrift.TBase<changeExponent_args, changeExponent_args._Fields>, java.io.Serializable, Cloneable, Comparable<changeExponent_args>   {
    ...
    private double exponent; // required
    ...
    public void set_exponent(double exponent) {
      this.exponent = exponent;
      set_exponent_isSet(true);
    }

    public void unset_exponent() {
    ...
    public boolean is_set_exponent() {
      return EncodingUtils.testBit(__isset_bitfield, __EXPONENT_ISSET_ID);
    }

    public void set_exponent_isSet(boolean value) {
    ...
    public Object getFieldValue(_Fields field) {
      switch (field) {
      case EXPONENT:
        return Double.valueOf(get_exponent());
    ...
    public int compareTo(changeExponent_args other) {
      ...
      lastComparison = Boolean.valueOf(is_set_exponent()).compareTo(other.is_set_exponent());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (is_set_exponent()) {
          ...
          switch (schemeField.id) {
            case 1: // EXPONENT
              if (schemeField.type == org.apache.thrift.protocol.TType.DOUBLE) {
                ...
                struct.set_exponent_isSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
