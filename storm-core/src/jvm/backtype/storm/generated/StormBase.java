            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i581 = 0; _i581 < _map578.size; ++_i581)
                {
                  ...
                  _val580 = iprot.readI32();
                  struct.component_executors.put(_key579, _val580);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                String _key583;
                DebugOptions _val584;
                for (int _i585 = 0; _i585 < _map582.size; ++_i585)
                {
                  _key583 = iprot.readString();
                  _val584 = new DebugOptions();
                  _val584.read(iprot);
                  struct.component_debug.put(_key583, _val584);
                }
                iprot.readMapEnd();
              }
      ...
      if (incoming.get(0)) {
        {
          ...
          for (int _i593 = 0; _i593 < _map590.size; ++_i593)
          {
            ...
            _val592 = iprot.readI32();
            struct.component_executors.put(_key591, _val592);
          }
        }
        struct.set_component_executors_isSet(true);
      }
      ...
      if (incoming.get(5)) {
        {
          ...
          String _key595;
          DebugOptions _val596;
          for (int _i597 = 0; _i597 < _map594.size; ++_i597)
          {
            _key595 = iprot.readString();
            _val596 = new DebugOptions();
            _val596.read(iprot);
            struct.component_debug.put(_key595, _val596);
          }
        }
        struct.set_component_debug_isSet(true);
      }
