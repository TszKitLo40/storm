...
public class StormBase implements org.apache.thrift.TBase<StormBase, StormBase._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.COMPONENT_EXECUTORS,_Fields.LAUNCH_TIME_SECS,_Fields.OWNER,_Fields.TOPOLOGY_ACTION_OPTIONS,_Fields.PREV_STATUS,_Fields.COMPONENT_DEBUG};
  ...
  public int hashCode() {
    ...
    builder.append(present_component_debug);
    if (present_component_debug)
      builder.append(component_debug);
  ...
  public int compareTo(StormBase other) {
    ...
    lastComparison = Boolean.valueOf(is_set_component_debug()).compareTo(typedOther.is_set_component_debug());
    if (lastComparison != 0) {
      return lastComparison;
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.component_executors = new HashMap<String,Integer>(2*_map578.size);
                for (int _i579 = 0; _i579 < _map578.size; ++_i579)
                {
                  ...
                  struct.component_executors.put(_key580, _val581);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.component_debug = new HashMap<String,DebugOptions>(2*_map582.size);
                for (int _i583 = 0; _i583 < _map582.size; ++_i583)
                {
                  String _key584; // required
                  DebugOptions _val585; // required
                  _key584 = iprot.readString();
                  _val585 = new DebugOptions();
                  _val585.read(iprot);
                  struct.component_debug.put(_key584, _val585);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.component_executors != null) {
        if (struct.is_set_component_executors()) {
          oprot.writeFieldBegin(COMPONENT_EXECUTORS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Integer> _iter586 : struct.component_executors.entrySet())
            {
      ...
      if (struct.component_debug != null) {
        if (struct.is_set_component_debug()) {
          oprot.writeFieldBegin(COMPONENT_DEBUG_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, DebugOptions> _iter587 : struct.component_debug.entrySet())
            {
  ...
  private static class StormBaseTupleScheme extends TupleScheme<StormBase> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, StormBase struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map590 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.component_executors = new HashMap<String,Integer>(2*_map590.size);
          for (int _i591 = 0; _i591 < _map590.size; ++_i591)
          {
            String _key592; // required
            int _val593; // required
            _key592 = iprot.readString();
            _val593 = iprot.readI32();
            struct.component_executors.put(_key592, _val593);
          }
        }
        struct.set_component_executors_isSet(true);
      }
      ...
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TMap _map594 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.component_debug = new HashMap<String,DebugOptions>(2*_map594.size);
          for (int _i595 = 0; _i595 < _map594.size; ++_i595)
          {
            String _key596; // required
            DebugOptions _val597; // required
            _key596 = iprot.readString();
            _val597 = new DebugOptions();
            _val597.read(iprot);
            struct.component_debug.put(_key596, _val597);
          }
        }
        struct.set_component_debug_isSet(true);
      }
