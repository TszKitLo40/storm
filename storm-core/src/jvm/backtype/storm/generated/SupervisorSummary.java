...
public class SupervisorSummary implements org.apache.thrift.TBase<SupervisorSummary, SupervisorSummary._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.VERSION,_Fields.TOTAL_RESOURCES};
  ...
  public int hashCode() {
    ...
    builder.append(present_total_resources);
    if (present_total_resources)
      builder.append(total_resources);
  ...
  public int compareTo(SupervisorSummary other) {
    ...
    lastComparison = Boolean.valueOf(is_set_total_resources()).compareTo(typedOther.is_set_total_resources());
    if (lastComparison != 0) {
      return lastComparison;
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i75 = 0; _i75 < _map74.size; ++_i75)
                {
                  ...
                  struct.total_resources.put(_key76, _val77);
                }
                iprot.readMapEnd();
              }
      ...
      if (incoming.get(1)) {
        {
          ...
          for (int _i81 = 0; _i81 < _map80.size; ++_i81)
          {
            ...
            struct.total_resources.put(_key82, _val83);
          }
        }
        struct.set_total_resources_isSet(true);
      }
