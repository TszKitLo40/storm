...
public class LocalStateData implements org.apache.thrift.TBase<LocalStateData, LocalStateData._Fields>, java.io.Serializable, Cloneable {
  ...
  public int hashCode() {
    ...
    builder.append(present_serialized_parts);
    if (present_serialized_parts)
      builder.append(serialized_parts);
  ...
  public int compareTo(LocalStateData other) {
    ...
    lastComparison = Boolean.valueOf(is_set_serialized_parts()).compareTo(typedOther.is_set_serialized_parts());
    if (lastComparison != 0) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.serialized_parts = new HashMap<String,ThriftSerializedObject>(2*_map608.size);
                for (int _i609 = 0; _i609 < _map608.size; ++_i609)
                {
                  String _key610; // required
                  ThriftSerializedObject _val611; // required
                  _key610 = iprot.readString();
                  _val611 = new ThriftSerializedObject();
                  _val611.read(iprot);
                  struct.serialized_parts.put(_key610, _val611);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LocalStateData struct) throws org.apache.thrift.TException {
      ...
      if (struct.serialized_parts != null) {
        oprot.writeFieldBegin(SERIALIZED_PARTS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, ThriftSerializedObject> _iter612 : struct.serialized_parts.entrySet())
          {
  ...
  private static class LocalStateDataTupleScheme extends TupleScheme<LocalStateData> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, LocalStateData struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<String, ThriftSerializedObject> _iter613 : struct.serialized_parts.entrySet())
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LocalStateData struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.serialized_parts = new HashMap<String,ThriftSerializedObject>(2*_map614.size);
        for (int _i615 = 0; _i615 < _map614.size; ++_i615)
        {
          String _key616; // required
          ThriftSerializedObject _val617; // required
          _key616 = iprot.readString();
          _val617 = new ThriftSerializedObject();
          _val617.read(iprot);
          struct.serialized_parts.put(_key616, _val617);
        }
      }
      struct.set_serialized_parts_isSet(true);
    }
