            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                String _key609;
                ThriftSerializedObject _val610;
                for (int _i611 = 0; _i611 < _map608.size; ++_i611)
                {
                  _key609 = iprot.readString();
                  _val610 = new ThriftSerializedObject();
                  _val610.read(iprot);
                  struct.serialized_parts.put(_key609, _val610);
                }
                iprot.readMapEnd();
              }
  ...
  private static class LocalStateDataTupleScheme extends TupleScheme<LocalStateData> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LocalStateData struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        String _key615;
        ThriftSerializedObject _val616;
        for (int _i617 = 0; _i617 < _map614.size; ++_i617)
        {
          _key615 = iprot.readString();
          _val616 = new ThriftSerializedObject();
          _val616.read(iprot);
          struct.serialized_parts.put(_key615, _val616);
        }
      }
      struct.set_serialized_parts_isSet(true);
    }
