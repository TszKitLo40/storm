...
public class ComponentPageInfo implements org.apache.thrift.TBase<ComponentPageInfo, ComponentPageInfo._Fields>, java.io.Serializable, Cloneable {
  ...
  public int hashCode() {
    ...
    if (present_component_type)
      builder.append(component_type.getValue());
    ...
    builder.append(present_topology_name);
    if (present_topology_name)
      builder.append(topology_name);
  ...
  public int compareTo(ComponentPageInfo other) {
    ...
    lastComparison = Boolean.valueOf(is_set_topology_name()).compareTo(typedOther.is_set_topology_name());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(is_set_window_to_stats()).compareTo(typedOther.is_set_window_to_stats());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(is_set_gsid_to_input_stats()).compareTo(typedOther.is_set_gsid_to_input_stats());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(is_set_sid_to_output_stats()).compareTo(typedOther.is_set_sid_to_output_stats());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(is_set_exec_stats()).compareTo(typedOther.is_set_exec_stats());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(is_set_eventlog_host()).compareTo(typedOther.is_set_eventlog_host());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(is_set_eventlog_port()).compareTo(typedOther.is_set_eventlog_port());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(is_set_debug_options()).compareTo(typedOther.is_set_debug_options());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(is_set_topology_status()).compareTo(typedOther.is_set_topology_status());
    if (lastComparison != 0) {
      return lastComparison;
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i415 = 0; _i415 < _map414.size; ++_i415)
                {
                  ...
                  ComponentAggregateStats _val417; // required
                  _key416 = iprot.readString();
                  _val417 = new ComponentAggregateStats();
                  _val417.read(iprot);
                  struct.window_to_stats.put(_key416, _val417);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                {
                  GlobalStreamId _key420; // required
                  ComponentAggregateStats _val421; // required
                  _key420 = new GlobalStreamId();
                  _key420.read(iprot);
                  _val421 = new ComponentAggregateStats();
                  _val421.read(iprot);
                  struct.gsid_to_input_stats.put(_key420, _val421);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                {
                  String _key424; // required
                  ComponentAggregateStats _val425; // required
                  _key424 = iprot.readString();
                  _val425 = new ComponentAggregateStats();
                  _val425.read(iprot);
                  struct.sid_to_output_stats.put(_key424, _val425);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  ExecutorAggregateStats _elem428; // required
                  _elem428 = new ExecutorAggregateStats();
                  _elem428.read(iprot);
                  struct.exec_stats.add(_elem428);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  ErrorInfo _elem431; // required
                  _elem431 = new ErrorInfo();
                  _elem431.read(iprot);
                  struct.errors.add(_elem431);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(4)) {
        {
          ...
          for (int _i443 = 0; _i443 < _map442.size; ++_i443)
          {
            ...
            ComponentAggregateStats _val445; // required
            _key444 = iprot.readString();
            _val445 = new ComponentAggregateStats();
            _val445.read(iprot);
            struct.window_to_stats.put(_key444, _val445);
          }
        }
        struct.set_window_to_stats_isSet(true);
      }
      if (incoming.get(5)) {
        {
          ...
          {
            GlobalStreamId _key448; // required
            ComponentAggregateStats _val449; // required
            _key448 = new GlobalStreamId();
            _key448.read(iprot);
            _val449 = new ComponentAggregateStats();
            _val449.read(iprot);
            struct.gsid_to_input_stats.put(_key448, _val449);
          }
        }
        struct.set_gsid_to_input_stats_isSet(true);
      }
      if (incoming.get(6)) {
        {
          ...
          for (int _i451 = 0; _i451 < _map450.size; ++_i451)
          {
            ...
            ComponentAggregateStats _val453; // required
            _key452 = iprot.readString();
            _val453 = new ComponentAggregateStats();
            _val453.read(iprot);
            struct.sid_to_output_stats.put(_key452, _val453);
          }
        }
        struct.set_sid_to_output_stats_isSet(true);
      }
      if (incoming.get(7)) {
        {
          ...
          {
            ExecutorAggregateStats _elem456; // required
            _elem456 = new ExecutorAggregateStats();
            _elem456.read(iprot);
            struct.exec_stats.add(_elem456);
          }
        }
        struct.set_exec_stats_isSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          {
            ErrorInfo _elem459; // required
            _elem459 = new ErrorInfo();
            _elem459.read(iprot);
            struct.errors.add(_elem459);
          }
        }
        struct.set_errors_isSet(true);
      }
