...
public class LSSupervisorAssignments implements org.apache.thrift.TBase<LSSupervisorAssignments, LSSupervisorAssignments._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(LSSupervisorAssignments other) {
    ...
    lastComparison = Boolean.valueOf(is_set_assignments()).compareTo(typedOther.is_set_assignments());
    if (lastComparison != 0) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                {
                  int _key638; // required
                  LocalAssignment _val639; // required
                  _key638 = iprot.readI32();
                  _val639 = new LocalAssignment();
                  _val639.read(iprot);
                  struct.assignments.put(_key638, _val639);
                }
                iprot.readMapEnd();
              }
  ...
  private static class LSSupervisorAssignmentsTupleScheme extends TupleScheme<LSSupervisorAssignments> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LSSupervisorAssignments struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        for (int _i643 = 0; _i643 < _map642.size; ++_i643)
        {
          int _key644; // required
          LocalAssignment _val645; // required
          _key644 = iprot.readI32();
          _val645 = new LocalAssignment();
          _val645.read(iprot);
          struct.assignments.put(_key644, _val645);
        }
      }
      struct.set_assignments_isSet(true);
    }
