...
public class SpoutAggregateStats implements org.apache.thrift.TBase<SpoutAggregateStats, SpoutAggregateStats._Fields>, java.io.Serializable, Cloneable {
  ...
  public int hashCode() {
    ...
    builder.append(present_complete_latency_ms);
    if (present_complete_latency_ms)
      builder.append(complete_latency_ms);
  ...
  public int compareTo(SpoutAggregateStats other) {
    ...
    lastComparison = Boolean.valueOf(is_set_complete_latency_ms()).compareTo(typedOther.is_set_complete_latency_ms());
    if (lastComparison != 0) {
