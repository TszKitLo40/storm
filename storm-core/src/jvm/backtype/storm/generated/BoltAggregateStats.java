...
public class BoltAggregateStats implements org.apache.thrift.TBase<BoltAggregateStats, BoltAggregateStats._Fields>, java.io.Serializable, Cloneable {
  ...
  public int hashCode() {
    ...
    builder.append(present_execute_latency_ms);
    if (present_execute_latency_ms)
      builder.append(execute_latency_ms);

    boolean present_process_latency_ms = true && (is_set_process_latency_ms());
    builder.append(present_process_latency_ms);
    if (present_process_latency_ms)
      builder.append(process_latency_ms);
  ...
  public int compareTo(BoltAggregateStats other) {
    ...
    lastComparison = Boolean.valueOf(is_set_execute_latency_ms()).compareTo(typedOther.is_set_execute_latency_ms());
    if (lastComparison != 0) {
    ...
    lastComparison = Boolean.valueOf(is_set_process_latency_ms()).compareTo(typedOther.is_set_process_latency_ms());
    if (lastComparison != 0) {
      return lastComparison;
    }
