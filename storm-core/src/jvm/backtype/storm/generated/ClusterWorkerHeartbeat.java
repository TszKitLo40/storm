            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.executor_stats = new HashMap<ExecutorInfo,ExecutorStats>(2*_map598.size);
                ExecutorInfo _key599;
                ExecutorStats _val600;
                for (int _i601 = 0; _i601 < _map598.size; ++_i601)
                {
                  _key599 = new ExecutorInfo();
                  _key599.read(iprot);
                  _val600 = new ExecutorStats();
                  _val600.read(iprot);
                  struct.executor_stats.put(_key599, _val600);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ClusterWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      if (struct.executor_stats != null) {
        oprot.writeFieldBegin(EXECUTOR_STATS_FIELD_DESC);
        {
          ...
          for (Map.Entry<ExecutorInfo, ExecutorStats> _iter602 : struct.executor_stats.entrySet())
          {
            _iter602.getKey().write(oprot);
            _iter602.getValue().write(oprot);
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class ClusterWorkerHeartbeatTupleScheme extends TupleScheme<ClusterWorkerHeartbeat> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, ClusterWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct.storm_id);
      {
        ...
        for (Map.Entry<ExecutorInfo, ExecutorStats> _iter603 : struct.executor_stats.entrySet())
        {
          _iter603.getKey().write(oprot);
          _iter603.getValue().write(oprot);
        }
      }
      oprot.writeI32(struct.time_secs);
      oprot.writeI32(struct.uptime_secs);
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ClusterWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      struct.set_storm_id_isSet(true);
      {
        org.apache.thrift.protocol.TMap _map604 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.executor_stats = new HashMap<ExecutorInfo,ExecutorStats>(2*_map604.size);
        ExecutorInfo _key605;
        ExecutorStats _val606;
        for (int _i607 = 0; _i607 < _map604.size; ++_i607)
        {
          _key605 = new ExecutorInfo();
          _key605.read(iprot);
          _val606 = new ExecutorStats();
          _val606.read(iprot);
          struct.executor_stats.put(_key605, _val606);
        }
      }
      struct.set_executor_stats_isSet(true);
      struct.time_secs = iprot.readI32();
