            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                {
                  ExecutorInfo _key600; // required
                  ExecutorStats _val601; // required
                  _key600 = new ExecutorInfo();
                  _key600.read(iprot);
                  _val601 = new ExecutorStats();
                  _val601.read(iprot);
                  struct.executor_stats.put(_key600, _val601);
                }
                iprot.readMapEnd();
              }
  ...
  private static class ClusterWorkerHeartbeatTupleScheme extends TupleScheme<ClusterWorkerHeartbeat> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ClusterWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      struct.set_storm_id_isSet(true);
      {
        ...
        {
          ExecutorInfo _key606; // required
          ExecutorStats _val607; // required
          _key606 = new ExecutorInfo();
          _key606.read(iprot);
          _val607 = new ExecutorStats();
          _val607.read(iprot);
          struct.executor_stats.put(_key606, _val607);
        }
      }
      struct.set_executor_stats_isSet(true);
      struct.time_secs = iprot.readI32();
