...
public class SupervisorInfo implements org.apache.thrift.TBase<SupervisorInfo, SupervisorInfo._Fields>, java.io.Serializable, Cloneable {
  ...
  public int hashCode() {
    ...
    builder.append(present_resources_map);
    if (present_resources_map)
      builder.append(resources_map);
  ...
  public int compareTo(SupervisorInfo other) {
    ...
    lastComparison = Boolean.valueOf(is_set_resources_map()).compareTo(typedOther.is_set_resources_map());
    if (lastComparison != 0) {
      return lastComparison;
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  long _elem482; // required
                  _elem482 = iprot.readI64();
                  struct.used_ports.add(_elem482);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  long _elem485; // required
                  _elem485 = iprot.readI64();
                  struct.meta.add(_elem485);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i487 = 0; _i487 < _map486.size; ++_i487)
                {
                  ...
                  struct.scheduler_meta.put(_key488, _val489);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i491 = 0; _i491 < _map490.size; ++_i491)
                {
                  ...
                  double _val493; // required
                  _key492 = iprot.readString();
                  _val493 = iprot.readDouble();
                  struct.resources_map.put(_key492, _val493);
                }
                iprot.readMapEnd();
              }
      ...
      if (incoming.get(1)) {
        {
          ...
          for (int _i503 = 0; _i503 < _list502.size; ++_i503)
          {
            ...
            struct.used_ports.add(_elem504);
          }
        }
        struct.set_used_ports_isSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          {
            long _elem507; // required
            _elem507 = iprot.readI64();
            struct.meta.add(_elem507);
          }
        }
        struct.set_meta_isSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          for (int _i509 = 0; _i509 < _map508.size; ++_i509)
          {
            ...
            String _val511; // required
            _key510 = iprot.readString();
            _val511 = iprot.readString();
            struct.scheduler_meta.put(_key510, _val511);
          }
        }
        struct.set_scheduler_meta_isSet(true);
      }
      ...
      if (incoming.get(6)) {
        {
          ...
          {
            String _key514; // required
            double _val515; // required
            _key514 = iprot.readString();
            _val515 = iprot.readDouble();
            struct.resources_map.put(_key514, _val515);
          }
        }
        struct.set_resources_map_isSet(true);
      }
