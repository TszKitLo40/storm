...
public class ExecutorAggregateStats implements org.apache.thrift.TBase<ExecutorAggregateStats, ExecutorAggregateStats._Fields>, java.io.Serializable, Cloneable {
  ...
  public int hashCode() {
    ...
    builder.append(present_exec_summary);
    if (present_exec_summary)
      builder.append(exec_summary);
  ...
  public int compareTo(ExecutorAggregateStats other) {
    ...
    lastComparison = Boolean.valueOf(is_set_exec_summary()).compareTo(typedOther.is_set_exec_summary());
    if (lastComparison != 0) {
