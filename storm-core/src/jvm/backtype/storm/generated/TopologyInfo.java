...
public class TopologyInfo implements org.apache.thrift.TBase<TopologyInfo, TopologyInfo._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.COMPONENT_DEBUG,_Fields.SCHED_STATUS,_Fields.OWNER,_Fields.REPLICATION_COUNT};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  ExecutorSummary _elem310; // required
                  _elem310 = new ExecutorSummary();
                  _elem310.read(iprot);
                  struct.executors.add(_elem310);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i312 = 0; _i312 < _map311.size; ++_i312)
                {
                  ...
                  List<ErrorInfo> _val314; // required
                  _key313 = iprot.readString();
                  {
                    org.apache.thrift.protocol.TList _list315 = iprot.readListBegin();
                    _val314 = new ArrayList<ErrorInfo>(_list315.size);
                    for (int _i316 = 0; _i316 < _list315.size; ++_i316)
                    {
                      ErrorInfo _elem317; // required
                      _elem317 = new ErrorInfo();
                      _elem317.read(iprot);
                      _val314.add(_elem317);
                    }
                    iprot.readListEnd();
                  }
                  struct.errors.put(_key313, _val314);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i319 = 0; _i319 < _map318.size; ++_i319)
                {
                  ...
                  DebugOptions _val321; // required
                  _key320 = iprot.readString();
                  _val321 = new DebugOptions();
                  _val321.read(iprot);
                  struct.component_debug.put(_key320, _val321);
                }
                iprot.readMapEnd();
              }
  ...
  private static class TopologyInfoTupleScheme extends TupleScheme<TopologyInfo> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TopologyInfo struct) throws org.apache.thrift.TException {
      ...
      struct.set_uptime_secs_isSet(true);
      {
        ...
        {
          ExecutorSummary _elem332; // required
          _elem332 = new ExecutorSummary();
          _elem332.read(iprot);
          struct.executors.add(_elem332);
        }
      }
      struct.set_executors_isSet(true);
      struct.status = iprot.readString();
      struct.set_status_isSet(true);
      {
        ...
        for (int _i334 = 0; _i334 < _map333.size; ++_i334)
        {
          ...
          List<ErrorInfo> _val336; // required
          _key335 = iprot.readString();
          {
            ...
            _val336 = new ArrayList<ErrorInfo>(_list337.size);
            for (int _i338 = 0; _i338 < _list337.size; ++_i338)
            {
              ErrorInfo _elem339; // required
              _elem339 = new ErrorInfo();
              _elem339.read(iprot);
              _val336.add(_elem339);
            }
          }
          struct.errors.put(_key335, _val336);
        }
      }
      struct.set_errors_isSet(true);
      ...
      if (incoming.get(0)) {
        {
          ...
          for (int _i341 = 0; _i341 < _map340.size; ++_i341)
          {
            ...
            DebugOptions _val343; // required
            _key342 = iprot.readString();
            _val343 = new DebugOptions();
            _val343.read(iprot);
            struct.component_debug.put(_key342, _val343);
          }
        }
        struct.set_component_debug_isSet(true);
      }
