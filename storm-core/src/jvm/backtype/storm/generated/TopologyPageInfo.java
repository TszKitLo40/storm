...
public class TopologyPageInfo implements org.apache.thrift.TBase<TopologyPageInfo, TopologyPageInfo._Fields>, java.io.Serializable, Cloneable {
  ...
  public int hashCode() {
    ...
    builder.append(present_id_to_spout_agg_stats);
    if (present_id_to_spout_agg_stats)
      builder.append(id_to_spout_agg_stats);

    boolean present_id_to_bolt_agg_stats = true && (is_set_id_to_bolt_agg_stats());
    builder.append(present_id_to_bolt_agg_stats);
    if (present_id_to_bolt_agg_stats)
      builder.append(id_to_bolt_agg_stats);
  ...
  public int compareTo(TopologyPageInfo other) {
    ...
    lastComparison = Boolean.valueOf(is_set_id_to_spout_agg_stats()).compareTo(typedOther.is_set_id_to_spout_agg_stats());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(is_set_id_to_bolt_agg_stats()).compareTo(typedOther.is_set_id_to_bolt_agg_stats());
    if (lastComparison != 0) {
      return lastComparison;
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i395 = 0; _i395 < _map394.size; ++_i395)
                {
                  ...
                  ComponentAggregateStats _val397; // required
                  _key396 = iprot.readString();
                  _val397 = new ComponentAggregateStats();
                  _val397.read(iprot);
                  struct.id_to_spout_agg_stats.put(_key396, _val397);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i399 = 0; _i399 < _map398.size; ++_i399)
                {
                  ...
                  ComponentAggregateStats _val401; // required
                  _key400 = iprot.readString();
                  _val401 = new ComponentAggregateStats();
                  _val401.read(iprot);
                  struct.id_to_bolt_agg_stats.put(_key400, _val401);
                }
                iprot.readMapEnd();
              }
      ...
      if (incoming.get(7)) {
        {
          ...
          for (int _i407 = 0; _i407 < _map406.size; ++_i407)
          {
            ...
            ComponentAggregateStats _val409; // required
            _key408 = iprot.readString();
            _val409 = new ComponentAggregateStats();
            _val409.read(iprot);
            struct.id_to_spout_agg_stats.put(_key408, _val409);
          }
        }
        struct.set_id_to_spout_agg_stats_isSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          for (int _i411 = 0; _i411 < _map410.size; ++_i411)
          {
            ...
            ComponentAggregateStats _val413; // required
            _key412 = iprot.readString();
            _val413 = new ComponentAggregateStats();
            _val413.read(iprot);
            struct.id_to_bolt_agg_stats.put(_key412, _val413);
          }
        }
        struct.set_id_to_bolt_agg_stats_isSet(true);
      }
