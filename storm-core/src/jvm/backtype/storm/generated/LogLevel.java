...
public class LogLevel implements org.apache.thrift.TBase<LogLevel, LogLevel._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(LogLevel other) {
    ...
    lastComparison = Boolean.valueOf(is_set_action()).compareTo(typedOther.is_set_action());
    if (lastComparison != 0) {
    ...
    lastComparison = Boolean.valueOf(is_set_target_log_level()).compareTo(typedOther.is_set_target_log_level());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(is_set_reset_log_level_timeout_secs()).compareTo(typedOther.is_set_reset_log_level_timeout_secs());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(is_set_reset_log_level_timeout_epoch()).compareTo(typedOther.is_set_reset_log_level_timeout_epoch());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(is_set_reset_log_level()).compareTo(typedOther.is_set_reset_log_level());
    if (lastComparison != 0) {
      return lastComparison;
    }
