...
public class ComponentAggregateStats implements org.apache.thrift.TBase<ComponentAggregateStats, ComponentAggregateStats._Fields>, java.io.Serializable, Cloneable {
  ...
  public int hashCode() {
    ...
    builder.append(present_common_stats);
    if (present_common_stats)
      builder.append(common_stats);

    boolean present_specific_stats = true && (is_set_specific_stats());
    builder.append(present_specific_stats);
    if (present_specific_stats)
      builder.append(specific_stats);
  ...
  public int compareTo(ComponentAggregateStats other) {
    ...
    lastComparison = Boolean.valueOf(is_set_common_stats()).compareTo(typedOther.is_set_common_stats());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(is_set_specific_stats()).compareTo(typedOther.is_set_specific_stats());
    if (lastComparison != 0) {
      return lastComparison;
    }
