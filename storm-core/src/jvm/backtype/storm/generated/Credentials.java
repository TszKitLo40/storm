            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                {
                  String _key472; // required
                  String _val473; // required
                  _key472 = iprot.readString();
                  _val473 = iprot.readString();
                  struct.creds.put(_key472, _val473);
                }
                iprot.readMapEnd();
              }
  ...
  private static class CredentialsTupleScheme extends TupleScheme<Credentials> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, Credentials struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        {
          String _key478; // required
          String _val479; // required
          _key478 = iprot.readString();
          _val479 = iprot.readString();
          struct.creds.put(_key478, _val479);
        }
      }
      struct.set_creds_isSet(true);
    }
