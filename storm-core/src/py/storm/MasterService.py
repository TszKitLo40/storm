...
class Processor(Iface, TProcessor):
  ...
  def process_getAllHostNames(self, seqid, iprot, oprot):
    ...
    oprot.writeMessageBegin("getAllHostNames", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_migrateTasks(self, seqid, iprot, oprot):
    ...
    try:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("migrateTasks", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_createRouting(self, seqid, iprot, oprot):
    ...
    try:
      ...
      raise
    except HostNotExistException as hmee:
      msg_type = TMessageType.REPLY
      result.hmee = hmee
    except Exception as ex:
      msg_type = TMessageType.EXCEPTION
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("createRouting", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_withdrawRemoteRoute(self, seqid, iprot, oprot):
    ...
    try:
      ...
      msg_type = TMessageType.REPLY
      result.e = e
    except HostNotExistException as hnee:
      msg_type = TMessageType.REPLY
      result.hnee = hnee
    except Exception as ex:
      msg_type = TMessageType.EXCEPTION
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("withdrawRemoteRoute", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_reportTaskThroughput(self, seqid, iprot, oprot):
    ...
    try:
      ...
      raise
    except TaskNotExistException as tnee:
      msg_type = TMessageType.REPLY
      result.tnee = tnee
    except Exception as ex:
      msg_type = TMessageType.EXCEPTION
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("reportTaskThroughput", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_queryDistribution(self, seqid, iprot, oprot):
    ...
    try:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("queryDistribution", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_getLiveWorkers(self, seqid, iprot, oprot):
    ...
    try:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("getLiveWorkers", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_queryRoutingTable(self, seqid, iprot, oprot):
    ...
    try:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("queryRoutingTable", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_reassignBucketToRoute(self, seqid, iprot, oprot):
    ...
    try:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("reassignBucketToRoute", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_optimizeBucketToRoute(self, seqid, iprot, oprot):
    ...
    try:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("optimizeBucketToRoute", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_optimizeBucketToRouteWithThreshold(self, seqid, iprot, oprot):
    ...
    try:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("optimizeBucketToRouteWithThreshold", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_subtaskLevelLoadBalancing(self, seqid, iprot, oprot):
    ...
    try:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("subtaskLevelLoadBalancing", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_workerLevelLoadBalancing(self, seqid, iprot, oprot):
    ...
    try:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("workerLevelLoadBalancing", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_queryWorkerLoad(self, seqid, iprot, oprot):
    ...
    try:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("queryWorkerLoad", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_naiveWorkerLevelLoadBalancing(self, seqid, iprot, oprot):
    ...
    try:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("naiveWorkerLevelLoadBalancing", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_scalingOutSubtask(self, seqid, iprot, oprot):
    ...
    try:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("scalingOutSubtask", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_scalingInSubtask(self, seqid, iprot, oprot):
    ...
    try:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("scalingInSubtask", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_logOnMaster(self, seqid, iprot, oprot):
    ...
    try:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("logOnMaster", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
