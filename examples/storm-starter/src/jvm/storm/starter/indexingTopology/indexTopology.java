...
import storm.starter.indexingTopology.bolt.IndexerBolt;
import storm.starter.indexingTopology.spout.CSVReaderSpout;
...
//        builder.setBolt("Dispatcher",new DispatcherBolt("Indexer","longitude",schema),1).shuffleGrouping("TupleGenerator");
        ...
        builder.setBolt("Indexer",new IndexerBolt("longitude", schema, 256, 65000000),1)
                .setNumTasks(1)
